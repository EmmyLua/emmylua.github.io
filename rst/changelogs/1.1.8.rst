...
--------------------------------------------------------------------------------------------------------------------
1. 修复 `issue 38 <https://github.com/tangzx/IntelliJ-EmmyLua/issues/38>`__ 影响其它语言断点的严重BUG
2. 修复 `issue 39 <https://github.com/tangzx/IntelliJ-EmmyLua/issues/39>`__ 当在其它语言中输入 ``:`` 字符时会强制调出完成提示框的严重BUG
3. 修复全局变量某些时候不能提示属性的BUG
4. 完善部分标准函数的文档注解
